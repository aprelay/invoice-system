// ANTI-SPAM Email Templates v2.0 - Universal Business Inquiry Subject Lines
// Strategy: Natural inquiry subjects that match business inquiry emails, no work orders

export function getRandomSubject(workOrder: string): string {
  const subjects = [
    // Simple inquiry subjects
    'Quick question',
